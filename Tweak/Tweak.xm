...
- (void)buildMainPanel {
    ...
    UILabel *sigLbl = [[UILabel alloc] initWithFrame:CGRectMake(pw - 80, 9, 60, 14)];
    sigLbl.text = @"dyilb";
    sigLbl.textColor = [TEXT_PRIMARY colorWithAlphaComponent:0.5];
    sigLbl.font = [UIFont boldSystemFontOfSize:9];
    sigLbl.textAlignment = NSTextAlignmentRight;
    [header addSubview:sigLbl];
    ...
    creditLbl.text = @"حقوق عبدالإله | dyilb";
